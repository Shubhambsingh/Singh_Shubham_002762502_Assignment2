...
public class ReadHADoctorJPanel extends javax.swing.JPanel {
    ...
    public ReadHADoctorJPanel(SignUpDirectory SignUpDirectory, HospitalDirectory HospitalDirectory, String HID, DoctorDirectory DoctorDirectory) {
        initComponents();
    ...
    private void initComponents() {
        ...
        tblDoctorDirectory.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "DoctorID", "PersonID", "Doctor's Name", "Age", "Address", "City", "State", "Pin Code", "Password"
            }
        ) {
                            ...
                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                ...
                                .addGroup(javax.swing.GroupLayout.Alignment.LEADING, layout.createSequentialGroup()
                                    ...
                                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        ...
                                        .addComponent(btnUpdateSignUp, javax.swing.GroupLayout.Alignment.TRAILING)))))))
    ...
    private void btnPersonViewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPersonViewActionPerformed
        ...
        Doctor selectedSignUp = (Doctor) model.getValueAt(selectedRowIndex,2);
    ...
    private void btnUpdateSignUpActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateSignUpActionPerformed
        ...
        DefaultTableModel model = (DefaultTableModel) tblDoctorDirectory.getModel();
        Doctor su = (Doctor) model.getValueAt(tblDoctorDirectory.getSelectedRow(), 1);
        ...
        if (tblDoctorDirectory.getSelectedRowCount()==1) {
            ...
            model.setValueAt(PersonID, tblDoctorDirectory.getSelectedRow(), 1);
            model.setValueAt(DoctorName, tblDoctorDirectory.getSelectedRow(), 2);
            model.setValueAt(Age, tblDoctorDirectory.getSelectedRow(), 3);
            model.setValueAt(Address, tblDoctorDirectory.getSelectedRow(), 4);
            model.setValueAt(City, tblDoctorDirectory.getSelectedRow(), 5);
            model.setValueAt(State, tblDoctorDirectory.getSelectedRow(), 6);
            model.setValueAt(PinCode, tblDoctorDirectory.getSelectedRow(), 7);
            model.setValueAt(CreatePassword, tblDoctorDirectory.getSelectedRow(), 8);
