...
public class HospitalLoginJFrame extends javax.swing.JFrame {
    ...
    public HospitalLoginJFrame(SignUpDirectory SignUpDirectory, HospitalDirectory HospitalDirectory, DoctorDirectory DoctorDirectory) {
        initComponents();
    ...
    private void btnLogInActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLogInActionPerformed
        ...
        for(Hospital selectedSignUp : HospitalDirectory.getHospitalDirectory())
        {
                ...
                {
                    new IndividualHospitalJFrame (SignUpDirectory, HospitalDirectory, txtHospitalID.getText(),DoctorDirectory).setVisible(true);
                    break;
                }
                else
                {
